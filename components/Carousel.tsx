...
export default function Carousel({language,intervalMs=5000}:CarouselProps){
  ...
  const lang:Lang=useMemo(()=>{
    ...
    if(ctx&&(ctx.language==="en"||ctx.language==="tet")){
      return ctx.language;
    }
  ...
  return(
    ...
    >
      ...
      <button
        type="button"
        onClick={prev}
        className="absolute left-4 top-1/2 z-50 -translate-y-1/2 rounded-full bg-white/80 p-2 shadow hover:bg-white focus:outline-none focus:ring-2 focus:ring-white/80"
      ...
      <button
        type="button"
        onClick={next}
        className="absolute right-4 top-1/2 z-50 -translate-y-1/2 rounded-full bg-white/80 p-2 shadow hover:bg-white focus:outline-none focus:ring-2 focus:ring-white/80"
