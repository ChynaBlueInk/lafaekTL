...
export async function POST(req:NextRequest){
  try{
    ...
    console.log('[presign] incoming body',{fileName,contentType,folder,REGION,BUCKET,BASE_PATH_NORMALISED})
    ...
    const allowed=['our-team','news','impact','uploads'] as const
    ...
    console.log('[presign] using key',{safeFolder,key})
