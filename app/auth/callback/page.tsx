...
export default function AuthCallbackPage(){
  ...
  useEffect(() => {
    ...
    // Once authenticated, send the user where we want them to land.
  ...
  // Not loading, not error, not authenticated yet:
  // show a brief message (the library usually finishes quickly)
  return (
    <div className="min-h-screen bg-white">
      <main className="mx-auto max-w-3xl px-6 py-14">
        <h1 className="text-2xl font-semibold text-[#333333]">{t.title}</h1>
