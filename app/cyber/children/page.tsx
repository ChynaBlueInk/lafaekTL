...
const TRANSLATIONS:Record<Lang,T>={
  en:{
    ...
    nextYouth:"Go to Youth",
    nextAdults:"Go to Parents & Teachers",
    ...
    <>
      ...
      <div className="cyber-page">
        <div className="nav-links">
          <Link href="/cyber" className="nav-link back">← {t.backToCyber}</Link>
          <Link href="/cyber/youth" className="nav-link youth">{t.nextYouth}</Link>
          <Link href="/cyber/adults" className="nav-link adults">{t.nextAdults}</Link>
        </div>
        ...
        <section className="sta-section">
          <h2 className="section-title">{t.stopThinkAskLead}</h2>
        ...
        <section className="links-section">
          <div className="links-box">
            <h3 className="section-title" style={{marginBottom:"0.5rem"}}>{t.linksTitle}</h3>
            <div className="links-row">
              <Link href="/cyber" className="links-btn back">← {t.backToCyber}</Link>
              <Link href="/cyber/youth" className="links-btn youth">{t.nextYouth}</Link>
              <Link href="/cyber/adults" className="links-btn adults">{t.nextAdults}</Link>
            </div>
          </div>
        </section>
      </div>
