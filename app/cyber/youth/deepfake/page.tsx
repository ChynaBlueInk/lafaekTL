...
export default function DeepfakePage(){
  ...
  const t={
    ...
    tet:{
      ...
      subtitle:"Aprende oinsá atu haree didi'ak foto, vídeo, no mensajen lian molok fiar ka fahe.",
      back:"Fila ba Youth Cyber Lab",
      gameBack:"Fila ba jogu",
      placeholder:"Klik marka ida atu hahu cheka.",
      imageAlt:"Amostra imajen estilo AI ho ema na'in rua no kotuk imajen blur",
      whyTitle:"Tanba sa ida-ne'e importante",
      whyBody1:
        "Ferramenta AI bele kria foto falsu, vídeo falsu, no lian falsu. Ema balu uza ba buat kreativu, maibé ema seluk uza atu bosok, moe, ameasa, ka engana ema.",
      whyBody2:
        "Foto ka vídeo la sempre prova loos. Molok fahe, hatán, selu, ka sai pániku, para uluk no cheka husi ne'ebé mak mai.",
      tipsTitle:"Cheka lalais: Para, Haree, Husu",
      tips:[
        "Para molok fahe buat ne'ebé halo ema hakfodak, moe, ka sente urjente.",
        "Haree didi'ak oin, naroman, roupa, no detallu iha kotuk imajen.",
        "Husu: sé mak posta, tanba sa agora, no ha'u bele cheka liu husi dalan seluk ka lae?",
        "Se la klaru, keta fahe. Husu uluk ba ema ne'ebé ita konfia.",
      ],
      panelTitle:"Atividade cheka imajen",
      panelIntro:"Klik marka sira iha imajen atu prátika cheka foto ne'ebé haree konvinsente tebes. Imajen AI di'ak dala ruma la iha erru klaru.",
  ...
  const features:Feature[]=[
    ...
    },
    {
      ...
      description:{
        ...
        tet:"Cheka matan hosi ema rua. Iha foto loos, matan dala barak simu naroman ho dalan natural. Iha imajen AI, refleksaun bele haree perfeitu demais, la hanesan, ka estranu uitoan.",
      },
      x:"35%",
      y:"35%",
    },
    {
      ...
      description:{
        ...
        tet:"Haree kulit. Imajen AI dala barak halo oin haree suave demais, ho marka ki'ik, linha, poru, ka diferensa natural menus liu foto loos.",
      },
      x:"33%",
      y:"28%",
    },
    ...
    },
    {
      ...
      description:{
        ...
        tet:"Kotuk imajen blur bele haree profesional, maibé mos bele subar erru. Cheka forma ne'ebé repete, beira estranu, ka buat ne'ebé la halo sentidu.",
      },
      x:"86%",
      y:"31%",
    },
