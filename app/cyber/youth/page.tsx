...
const TRANSLATIONS:Record<Lang,T>={
  en:{
    ...
    moves:[
      ...
      {
        title:"Question AI-generated content",
        desc:"Check videos, images, and voice messages for odd details, fake urgency, and accounts that look new or suspicious.",
      },
    ],
  ...
  tet:{
    ...
    movesTitle:"MOVIMENTU ESENSIAL 9",
    moves:[
      {
      ...
      {
        title:"Dúvida média ne'ebé AI halo",
        desc:"Haree vídeo, imajen, no voz sira ba detallu estranho, urjénsia falsu, no konta foun ka suspeitu sira.",
      },
    ],
  ...
  return(
    <>
      <style>{`
        ...
        .top-link.back:hover { color: #00FFC8; }
        .top-link.children {
          background: #FF6B6B;
          color: white;
        }
      ...
      <div className="yp">
        <div className="top-link-wrap">
          <Link href="/cyber" className="top-link back">← {t.backToCyber}</Link>
          <Link href="/cyber/children" className="top-link children">{t.toChildren}</Link>
          <Link href="/cyber/adults" className="top-link adults">{t.toAdults}</Link>
        </div>
        ...
        <div className="two-col">
          <div className="panel" style={{padding:"1.5rem"}}>
            <h3 className="section-title accent-cyan" style={{fontSize:"0.85rem",marginBottom:"1rem"}}>
              {t.accountsTitle}
            </h3>
          ...
          <div className="panel" style={{padding:"1.5rem"}}>
            <h3 className="section-title accent-mag" style={{fontSize:"0.85rem",marginBottom:"1rem"}}>
              {t.privacyTitle}
            </h3>
        ...
        <section className="links-section">
          <div className="links-box">
            <h3 className="section-title accent-cyan" style={{marginBottom:"0.5rem"}}>{t.linksTitle}</h3>
